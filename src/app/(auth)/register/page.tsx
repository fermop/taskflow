  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen p-4 bg-zinc-50">
      <div className="w-full max-w-md p-8 bg-white border border-zinc-200 rounded-2xl shadow-sm">
        <h1 className="text-2xl font-bold text-zinc-800 mb-6 text-center">Crear cuenta</h1>
        ...
        <p className="mt-6 text-center text-sm text-zinc-600">
          ¿Ya tienes cuenta? <Link href="/login" className="text-zinc-900 font-semibold hover:underline">Inicia sesión</Link>
        </p>
      </div>
    </div>
  );
